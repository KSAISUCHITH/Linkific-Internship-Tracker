...
import { BookOpen, Calendar, Heart, Pencil, Trash2 } from 'lucide-react'
    ...
    <article className="group flex h-full flex-col overflow-hidden rounded-xl border border-[#ddd7cb] bg-white shadow-xs transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl">
      <div className="relative h-56 w-full overflow-hidden bg-[#ebe6dc]">
        ...
        <button
          ...
          className={`absolute top-3 left-3 z-10 flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold shadow-sm transition-all duration-200 cursor-pointer backdrop-blur-md ${
            isFavorite
        ...
        >
          <Heart
            ...
            className={`transition-colors ${
              isFavorite ? 'fill-red-500 text-red-500' : 'text-[#666]'
            }`}
          />
      ...
      <div className="flex flex-1 flex-col p-5">
        <div className="flex-1">
          ...
          <div className="mt-3.5 pt-3 border-t border-[#f5f1e8] flex items-center justify-between">
